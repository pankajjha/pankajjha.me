...
self.addEventListener('activate', function (event) {
  ...
  event.waitUntil(_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
self.addEventListener('fetch', function (event) {
  ...
  if (event.request.mode === 'navigate') {
    event.respondWith(_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
