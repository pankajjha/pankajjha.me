...
self.addEventListener('install', function (event) {
  event.waitUntil(_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var cache;
...
self.addEventListener('fetch', function (event) {
  ...
  if (event.request.mode === 'navigate') {
    event.respondWith(_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3() {
...
module.exports = __webpack_require__(/*! /Users/pankajjha/development/htdocs/custom-repositories/pankajjha_me/resources/js/service-worker.js */"./resources/js/service-worker.js");
